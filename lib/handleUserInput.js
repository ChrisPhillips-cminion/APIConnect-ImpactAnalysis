...
function handleUserInput(e, r) {
    ...
    function o(e, r) {
        ...
        var n = [],
            o = {};
        n.push("Service - Host / QueueManager"), n.push("Service - ContextRoute / Queue"), n.push("API"), n.push("Product"), n.push("Plan"), n.push("Application"), o = {
    ...
    void 0 === e.organization && (u = {
        ...
        e = extend(e, r), t(e)
    }) : void 0 !== e.catalog && void 0 !== e.organization ? o(e, function() {
        f.apicLogin(e, function() {
            return r()
        })
    }) : t(e)
