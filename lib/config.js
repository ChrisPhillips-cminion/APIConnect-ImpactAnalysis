...
if ((isFlag("--help") || isFlag("-h")) && (config.showHelp = !0), (isFlag("--debug") || isFlag("-d")) && (config.debug = false), isFlag("--csv") && (config.output = "csv"), isFlag("--file") && (config.file = flagValue("--file")), isFlag("--json") && (config.output = "json"), isFlag("--save") || isFlag("-s")) {
