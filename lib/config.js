...
if ((isFlag("--help") || isFlag("-h")) && (config.showHelp = !0), (isFlag("--debug") || isFlag("-d")) && (config.debug = !0), isFlag("--json") && (config.output = "json"), isFlag("--save") || isFlag("-s")) {
