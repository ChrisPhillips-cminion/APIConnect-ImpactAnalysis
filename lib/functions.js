...
Array.prototype.contains = function(e) {
    ...
    console.log("node apicia.js [--json] [--load <path>] [--help] "), console.log("--load <path> 		-	 Load Config from path"), console.log("--json 			-	 print the response in JSON"), console.log("--help  		-	 this message")
};
