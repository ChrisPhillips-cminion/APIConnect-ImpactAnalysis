    ...
    fet.ObjectForEachThen(e, function(callbackSub, p) {
            if (p === 'mqinvoke') {
                ...
                replaceVariables(e.mqinvoke.queuemanager, assembly,catalog, function(resp) {
                    svc.queuemanager = resp;
                    replaceVariables(e.mqinvoke.queue, assembly,catalog, function(resp) {
                        svc.queue = resp;
                        replaceVariables(e.mqinvoke.replyqueue, assembly,catalog, function(resp) {
                            svc.replyqueue = resp;
                            replaceVariables(e.mqinvoke.backoutq, assembly,catalog, function(resp) {
                                svc.backoutq = resp;
                ...
                replaceVariables(url, assembly,catalog, function(resp) {
                    results.apis.service.push(resp);
                });
